				...
				<section class="py-4">
					<div class="container">
						<div class="toolbox d-lg-flex align-items-center mb-3 gap-2 p-3 bg-white border">
							...
							<div> <a href="shop-list-filter-on-top.html" class="btn btn-white rounded-0"><i
								...
								<div class="col-12 col-xl-9">
									<div class="product-grid">
										<div class="card rounded-0 product-card">
											...
											<div class="row g-0">
												<div class="col-md-4">
													<img src="assets/img/book1.jpg" class="img-fluid" alt="...">
												</div>
												<div class="col-md-8">
													<div class="card-body">
										...
										<div class="card rounded-0 product-card">
											...
											<div class="row g-0">
												<div class="col-md-4">
													<img src="assets/img/book10.jpg" class="img-fluid" alt="...">
												</div>
												<div class="col-md-8">
													<div class="card-body">
														<div class="product-info">
										...
										<div class="card rounded-0 product-card">
											...
											<div class="row g-0">
												<div class="col-md-4">
													<img src="assets/img/book11.jpg" class="img-fluid" alt="...">
												</div>
												<div class="col-md-8">
													<div class="card-body">
														<div class="product-info">
										...
										<div class="card rounded-0 product-card">
											...
											<div class="row g-0">
												<div class="col-md-4">
													<img src="assets/img/book12.jpg" class="img-fluid" alt="...">
												</div>
												<div class="col-md-8">
													<div class="card-body">
														<div class="product-info">
										...
										<div class="card rounded-0 product-card">
											...
											<div class="row g-0">
												<div class="col-md-4">
													<img src="assets/img/book14.jpg" class="img-fluid" alt="...">
												</div>
												<div class="col-md-8">
													<div class="card-body">
														<div class="product-info">
										...
										<div class="card rounded-0 product-card">
											...
											<div class="row g-0">
												<div class="col-md-4">
													<img src="assets/img/book3.jpg" class="img-fluid" alt="...">
												</div>
												<div class="col-md-8">
													<div class="card-body">
														<div class="product-info">
									...
									<div class="bestseller-list mb-3 border p-3 bg-dark-gery">
										...
										<div class="d-flex align-items-center">
											<div class="bottom-product-img">
												<a href="javascript:;">
													<img src="assets/img/book7.jpg" width="90" alt="">
												</a>
											</div>
											<div class="ms-0">
										...
										<div class="d-flex align-items-center">
											<div class="bottom-product-img">
												<a href="javascript:;">
													<img src="assets/img/book9.jpg" width="90" alt="">
												</a>
											</div>
											<div class="ms-0">
												<h6 class="mb-0 fw-light mb-1">Product Short Name</h6>
										...
										<div class="d-flex align-items-center">
											<div class="bottom-product-img">
												<a href="javascript:;">
													<img src="assets/img/book2.jpg" width="90" alt="">
												</a>
											</div>
											<div class="ms-0">
												<h6 class="mb-0 fw-light mb-1">Product Short Name</h6>
										...
										<div class="d-flex align-items-center">
											<div class="bottom-product-img">
												<a href="javascript:;">
													<img src="assets/img/book5.jpg" width="90" alt="">
												</a>
											</div>
											<div class="ms-0">
												<h6 class="mb-0 fw-light mb-1">Product Short Name</h6>
										...
										<div class="d-flex align-items-center">
											<div class="bottom-product-img">
												<a href="javascript:;">
													<img src="assets/img/book11.jpg" width="90" alt="">
												</a>
											</div>
											<div class="ms-0">
												<h6 class="mb-0 fw-light mb-1">Product Short Name</h6>
