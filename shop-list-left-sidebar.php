							...
							<div class="col-12 col-xl-9">
								<div class="product-wrapper">
									<div class="toolbox d-flex align-items-center mb-3 gap-2">
										...
										<div>	<a href="shop-grid-left-sidebar.html" class="btn btn-light rounded-0"><i class='bx bxs-grid me-0'></i></a>
										</div>
										<div>	<a href="shop-list-left-sidebar.html" class="btn btn-white rounded-0"><i class='bx bx-list-ul me-0'></i></a>
										</div>
									</div>
									<div class="product-grid">
										...
										<div class="card rounded-0 product-card">
											...
											<div class="row g-0">
												<div class="col-md-4">
													<img src="assets/img/book13.jpg" class="img-fluid" alt="...">
												</div>
												<div class="col-md-8">
													<div class="card-body">
														<div class="product-info">
										...
										<div class="card rounded-0 product-card">
											...
											<div class="row g-0">
												<div class="col-md-4">
													<img src="assets/img/book2.jpg" class="img-fluid" alt="...">
												</div>
												<div class="col-md-8">
													<div class="card-body">
														<div class="product-info">
